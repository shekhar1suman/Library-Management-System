...
class LibraryManagementSystem:
    def __init__(self, root):
        ...
        lbltitle = Label(self.root, text="LIBRARY MANAGEMENT SYSTEM", bg="#032b5c", fg="#077602", bd=20, relief=RIDGE,
                         font=("times new roman", 50, "bold"), padx=2, pady=6)
        lbltitle.pack(side=TOP, fill=X)

        frame = Frame(self.root, bd=12, relief=RIDGE, padx=20, bg="#032b5c")
        frame.place(x=0, y=130, width=1530, height=400)

        # ================================DATAFRAMELEFT====================================#
        DataFrameLeft = LabelFrame(frame, text="Library Membership Information", bg="#032b5c", fg="#077602", bd=15,
                                   relief=RIDGE, font=("times new roman", 15, "bold"))
        DataFrameLeft.place(x=0, y=5, width=900, height=350)

        lblMember = Label(DataFrameLeft, font=("arial", 12, "bold"), text="Member Type", padx=2, pady=6, bg="#032b5c")
        ...
        lblPRN_No = Label(DataFrameLeft, font=("arial", 12, "bold"), text="PRN No:", padx=2, bg="#032b5c")
        ...
        lblAuthor = Label(DataFrameLeft, font=("arial", 12, "bold"), text="Author Name:", padx=2, pady=6, bg="#032b5c")
        ...
        lblDateDue = Label(DataFrameLeft, font=("arial", 12, "bold"), text="Date Due:", padx=2, pady=6, bg="#032b5c")
        ...
        DataFrameRight = LabelFrame(frame, bd=12, padx=20, fg="#077602", relief=RIDGE, bg="#032b5c",
